...
.profile_info .left img{
  border-radius: 5px;
  margin-bottom: 10px;
}

.profile_info .left h4{
  font-size: 25px;
  margin-bottom: 10px;
}
...
.profile_info .right .info,
.profile_info .right .gurdian{
  margin-bottom: 25px;
}

.profile_info .right .info h3,
.profile_info .right .gurdian h3{
    margin-bottom: 15px;
    padding-bottom: 5px;
...
.profile_info .right .info_data,
.profile_info .right .gurdian_data{
  display: flex;
  justify-content: space-between;
}

.profile_info .right .info_data .data,
.profile_info .right .gurdian_data .data{
  width: 45%;
}

.profile_info .right .info_data .data h4,
.profile_info .right .gurdian_data .data h4{
    color: #353c4e;
    margin-bottom: 5px;
}

.profile_info .right .info_data .data p,
.profile_info .right .gurdian_data .data p{
  font-size: 13px;
  margin-bottom: 10px;
  color: #919aa3;
}
        ...
        $sql = "SELECT * FROM images where roll='$roll' limit 1;";
          ...
          if (mysqli_num_rows($res) > 0) {
            while ($images = mysqli_fetch_assoc($res)) {  ?>
              ...
              <img src="uploads/<?=$images['image_url']?>" width="200px" height="auto" class="profile_picture">
              
    <?php } }?>
       <?php echo "<h4>$fullname</h4>"; ?>
        <?php echo "<p>@$username</p>"; ?>
        <?php echo "<p>Student Id: $roll</p>"; ?>
    </div>
    <div class="right">
        <div class="info">
            ...
            <div class="info_data">
                 ...
                 <div class="data">
                   <h4>Date Of Birth</h4>
                 <?php echo "  <p>$date_of_birth</p>"; ?>
              </div>
            </div>
        </div>
      
      <div class="gurdian">
            <h3>Gurdian's Information</h3>
            <div class="gurdian_data">
                 <div class="data">
                    <h4>Gurdian Name</h4>
                  <?php echo "  <p>$gurdian_name</p>"; ?>
                 </div>
                 <div class="data">
                   <h4>Gurdian's Email</h4>
                    <?php echo "  <p>$gurdian_email</p>"; ?>
              </div>
            </div>
        </div>
        <div class="button">
