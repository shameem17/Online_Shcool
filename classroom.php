...
.class_info .right .info_data .data,
.class_info .right .gurdian_data .data :hover{
			...
			<div class="head-title">
				<div class="left">
					...
					<ul class="breadcrumb">
						...
						<li>
							<a class="active" href="#">Classroom</a>
						</li>
					</ul>
				</div>
				<div class="date">
...
<div class="class_info">
    <div class="left">
      ...
      if($now=="No Class Today"||$now=='No Class In This Priod'||$now=='BREAK'||$now=='-')
      {
        if($now=="-")
        {
          $now="Break Time";
      ...
      {
            echo "<i class=\"fa fa-book\" aria-hidden=\"true\" style=\"width:200px;\"></i><br><br><h3>$now</h3><br><h4>$teacher</h4><div class=\"join_class\"> <a href=\"index.php?join=$now\"  >Join Class</a></div>";
